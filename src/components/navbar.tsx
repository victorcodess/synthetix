...
const Navbar = ({ settings }: NavbarProps) => {
  return (
    <nav className="relative mx-16 flex w-full items-center justify-between">
      ...
      <a
        href="/"
        className="absolute left-0 right-0 top-0 mx-auto  flex w-min items-center justify-center"
      >
      ...
      <button className="rounded-full bg-gradient-to-b from-white/[5%] to-white/[15%] px-7 py-4 text-base leading-[23.04px] tracking-[-0.16px] text-white outline outline-2 -outline-offset-[2px] outline-white/[12%] backdrop-blur-[50px] hover:bg-white/[12%]">
        Contact Us
      </button>
    </nav>
  );
